                ...
                <tr key={trans.transaction_hash}>
                    ...
                    <div className="flex items-left">
                        ...
                        <div className="text-sm py-2 whitespace-nowrap leading-8">
                            <p><a href={process.env.REACT_APP_STELLAR_TRANS_URL + trans.transaction_hash} target="_blank">{trans.transaction_hash.substring(0,13)}... <img src="images/open-external.svg" className="inline-block" alt="Open external site" /></a></p>
                        </div>
                        </div>
                    </div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      {!trans.ethTrans ? (
                        ...
                        <div>  
                          <a href={process.env.REACT_APP_ETHER_TRANS_URL + trans.ethTrans} target="_blank">
                        ...
                        <div>  
                          <a className={buttonClasses.replace('bg-tap_blue', 'bg-tap_orange')} href={process.env.REACT_APP_ETHER_TRANS_URL + trans.ethTrans} target="_blank">
